...
:py:func:`destin.jubeatplus.cipher.bgm_key`, and, apart from the newer ``infov3`` metadata, none of
...
:py:func:`destin.jubeatplus.cipher.texture_key` and do carry the four-byte header, exactly as a
