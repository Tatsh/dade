...
Every renderer here projects a scene with :py:mod:`destin.thps2pc.raster` and returns a
:py:class:`destin.thps2pc.raster.Framebuffer`, leaving the caller to decide where the image goes.
