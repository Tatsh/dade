...
The cipher itself is :py:mod:`destin.common.bfcodec`, which *jubeat plus* shares; only the key
...
from destin.common.bfcodec import (
    BLOWFISH_INIT_WORDS,
    DEFAULT_IV,
...
class BFCodec(CommonBFCodec):
    ...
    iv : bytes
        ...
        :py:data:`destin.common.bfcodec.DEFAULT_IV`.
    """
