...
Both package kinds are ZIPs whose entries are :mod:`BFCodec <destin.rhythmin.bfcodec>` payloads.
...
def read_sheet(package: Path, suffix: str, key: bytes | None = None) -> Sheet:
    ...
    KeyError
        ...
        check out raises the :py:class:`ValueError` :py:func:`destin.rhythmin.bfcodec.decipher`
        raises.
    """
