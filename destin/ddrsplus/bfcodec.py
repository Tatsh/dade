...
The block cipher is :py:mod:`destin.common.bfcodec`, which *pop'n rhythmin* and *jubeat plus*
...
from destin.common.bfcodec import DEFAULT_IV, Blowfish
...
def _cbc_decrypt(cipher: Blowfish, data: bytes, iv: bytes) -> bytes:
    ...
    Parameters
    ----------
    cipher : destin.common.bfcodec.Blowfish
