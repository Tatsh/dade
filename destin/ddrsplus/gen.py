...
case :py:mod:`destin.ddrsplus.bfcodec` deciphers it, or it is stored in the clear.
...
from destin.ddrsplus.bfcodec import DEFAULT_IV, GEN_KEY, KDEI_MAGIC, decipher
