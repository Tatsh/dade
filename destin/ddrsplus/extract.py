...
from destin.common.ssq import DIFFICULTY_NAMES, STEPS_TYPES, TICKS_PER_BEAT, chart_notes, parse_ssq
from destin.common.stepmania import SimfileChart, write_sm
from destin.ddrsplus.bfcodec import DEFAULT_IV, GEN_KEY
from destin.ddrsplus.gap import estimate_gap
from destin.ddrsplus.gen import parse_chart_table, parse_metadata, read_gen
from destin.ddrsplus.pvr import BANNER_SIZE, crop, decode_pvr

if TYPE_CHECKING:
    from collections.abc import Sequence
    from pathlib import Path

    from destin.common.ssq import SSQ, Chart
    from destin.ddrsplus.gen import SongMetadata
...
def _meters(charts: Sequence[Chart], slots: dict[int, int], levels: Sequence[int]) -> list[int]:
    ...
    Parameters
    ----------
    charts : collections.abc.Sequence[destin.common.ssq.Chart]
...
def _simfile(ssq: SSQ, metadata: SongMetadata | None, slots: dict[int, int], banner: str,
    ...
    Parameters
    ----------
    ssq : destin.common.ssq.SSQ
        The parsed charts and tempo map.
    metadata : destin.ddrsplus.gen.SongMetadata | None
...
def _chart_end(charts: Sequence[SSQ], bpm: float) -> float:
    ...
    Parameters
    ----------
    charts : collections.abc.Sequence[destin.common.ssq.SSQ]
