...
themselves. Both games write the same tagged stream, and :py:mod:`dade.maxpayne.ldb` and
:py:mod:`dade.maxpayne.ldb2` therefore share their reader and their glTF exporter; the level
layouts differ, and :py:mod:`dade.maxpayne.ldb2` documents where.
