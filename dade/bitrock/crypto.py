...
encrypted cookfs page. The underlying :py:class:`~dade.common.twofish.Twofish` cipher and its CBC
helpers live in :py:mod:`dade.common.twofish` and are re-exported here for convenience.
...
def parse_payload_info(data: bytes) -> PayloadInfo:
    ...
    :py:class:`~dade.bitrock.typing.PayloadInfo`.
