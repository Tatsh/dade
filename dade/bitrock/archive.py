"""Convenience wrapper tying a source to the sans-I/O :py:class:`~dade.bitrock.sansio.CookFS`."""
...
class InstallBuilderFile:
    ...
    implementing :py:class:`~dade.bitrock.typing.Reader`. When given a path, the mapping is
