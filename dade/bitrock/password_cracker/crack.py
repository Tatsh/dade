...
if TYPE_CHECKING:
    ...
    from dade.bitrock.typing import PayloadInfo, Reader
    ...
    See :py:func:`~dade.bitrock.password_cracker.cuda.crack_cuda` and kin.
    """
...
def crack(installer: str | Path | bytes | bytearray | memoryview | Reader,
    ...
    installer : str | :py:class:`~pathlib.Path` | bytes | bytearray | memoryview | Reader
        ...
        :py:class:`~dade.bitrock.typing.Reader`.
    source : Mask | Iterable[str | bytes]
