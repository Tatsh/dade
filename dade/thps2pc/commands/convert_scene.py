"""``dade thps2pc convert-scene`` - export a PSX scene as a mesh with its textures."""
...
from dade.thps2pc.imagemagick import ImageMagickNotFoundError, convert
from dade.thps2pc.mesh import (
    DEFAULT_SCALE,
    UNTEXTURED_KEY,
    build_batches,
    index_bitmaps,
