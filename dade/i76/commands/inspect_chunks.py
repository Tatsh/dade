"""``dade i76 inspect-chunks`` - dump the FOURCC chunk tree of a BWD2 container."""
...
from dade.i76.bwd2 import DEFAULT_CONTAINER_TAGS, ascii_strings, walk
...
if TYPE_CHECKING:
    ...
    from dade.i76.typing import Chunk
