...
Sound effects ship as Core Audio Format (``.caf``) files of uncompressed PCM, a
...
is already a portable container, and it is written out as it is rather than transcoded.
