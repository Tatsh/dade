"""``dade jubeatplus unpack`` - convert a whole download to open formats."""
...
from dade.jubeatplus.pipeline import unpack as unpack_download

__all__ = ('unpack',)

log = logging.getLogger(__name__)

debug_option = bascom.debug_option({'dade.common': {}, 'dade.jubeatplus': {}})
