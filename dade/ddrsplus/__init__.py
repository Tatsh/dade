...
- :mod:`dade.ddrsplus.bfcodec` - the ``KDEI`` framing around the shared ``BFCodec`` cipher.
- :mod:`dade.ddrsplus.gen` - the container itself, its metadata, and its note count tables.
- :mod:`dade.ddrsplus.pvr` - the PowerVR banner textures.
