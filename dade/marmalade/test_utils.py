...
def build_font(pitch: int, height: int) -> bytes:
    """
    Build a minimal ``CIwGxFont`` body decodable by :func:`dade.marmalade.font.decode_font`.
...
def build_material(*,
    ...
    """
    Build a ``CIwMaterial`` body decodable by :func:`dade.marmalade.material.decode_material`.
...
def build_model(vertices: Sequence[tuple[int, int, int]],
    ...
    -------
    bytes
        A ``CIwModel`` body decodable by :func:`dade.marmalade.model.decode_model`.
    """
