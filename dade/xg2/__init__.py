...
- :func:`dade.common.lz.decompress_lzss0` - the Okumura LZSS variant both games use.
- :func:`dade.xg2.archive.parse_archive` / :func:`dade.xg2.archive.decode_entry` - the
  ``XG2Arch`` container, in either byte order.
- :func:`dade.xg2.mfs.iter_files` - the Extreme-G 1 ``mfs`` archive, including base calibration.
- :func:`dade.xg2.models.collect_textures` - every texture in a model blob, whatever its shape.
- :func:`dade.xg2.albank.parse_bank` - an ``ALBankFile`` bank with its sounds decoded to PCM.
