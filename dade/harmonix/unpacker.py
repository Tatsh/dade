...
class Unpacker:
    ...
    yield an :py:class:`dade.harmonix.typing.Asset` per entry of every ARK on :py:attr:`source`,
    ...
    def __aiter__(self) -> AsyncIterator[Asset]:
        ...
        Returns
        -------
        collections.abc.AsyncIterator[dade.harmonix.typing.Asset]
    ...
    async def unpack(self,
        ...
        dict[str, str]
            ...
            :py:func:`dade.harmonix.pipeline.run_game`.
